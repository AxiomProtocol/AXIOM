...
> Note: SNOWTRACE_API_KEY env var exists but Hardhat 3 routes to Sourcify for Fuji (chainId 43113).
> All 3 Axiom custom contracts verified on Sourcify. T-REX official contracts (1–5) are pre-verified by @tokenysolutions.

```bash
# Verified via: cd hardhat-avalanche && npx hardhat verify --config hardhat.config.mts --network avalancheFuji <address> [args]
```

- [x] CountryAllowModule — verified on Sourcify: https://sourcify.dev/server/repo-ui/43113/0xe15Cf94D324cc8882015ed71C39F002e3709ec54
- [x] TransferLimitModule — verified on Sourcify: https://sourcify.dev/server/repo-ui/43113/0x8D550a2ff71b7b92E98377452A34D3cE56B687Bc
- [x] AxiomStable3643Fuji — verified on Sourcify: https://sourcify.dev/server/repo-ui/43113/0x5Cd7c15C32e0630239eDE74241Ad65f3302BcAF8
- [ ] T-REX contracts (1–5) — pre-verified by @tokenysolutions upstream (no action needed)
...
- [x] Commit and push addresses to repository (pushed to main branch 2026-05-13)
- [x] `deployments/avalanche/fuji-phase1.json` pushed to main (dryRun: false)
