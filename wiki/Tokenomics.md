...
| **Treasury** | 20% | 3,000,000,000 | 36 months, 6mo cliff |
...
- Validator staking
- Option consideration staking (8% APR)
- Liquidity provision
...
1. **Fee Burns** - Portion of fees burned
2. **Treasury Buybacks** - Regular buyback programs
3. **Staking Locks** - Reduced circulating supply
4. **Governance Deposits** - Locked for proposals
...
## CoinGecko/CoinMarketCap Categories
