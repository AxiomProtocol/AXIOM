...
- **MIRDT Execution Model**: A deterministic, auditable engine for paper trading based on MIRDT market intelligence setups, processing through a pipeline of price fetching, direction inference, classification, sizing, and decision storage.
