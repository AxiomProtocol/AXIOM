...
-   **Axiom SUSU (Rotating Savings Groups)**: On-chain ROSCA system branded as "The Wealth Practice" with two custody modes:
    ...
    - **Trust Bridge**: Modal explainer on /susu page explaining two-stage trust system (Purpose Groups → SUSU Circles) and graduation process. Non-investment disclaimer on /wealth-practice. Whitepaper links on both pages.
