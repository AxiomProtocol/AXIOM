...
- EulerSwap AXUSD Liquidity Layer (Task #40, DEPLOYED 2026-03-25): USDC/AXUSD pool at `0x0101D5adE5Ce318FE39be50E985e4fa05362a8A8` — deployed empty (equilibriumReserve=0, minReserve=0) to pass CurveLib.verify() without requiring AXUSD at deployment time. EVC operator auth confirmed. LPM whitelist pending admin action: `LPM.addPlatform(0xaC9E1A91D1C7F584C9FC04E283fae30Ae2F636DD, 0x0101D5adE5Ce318FE39be50E985e4fa05362a8A8)`. Seed liquidity via Euler UI then call `pool.reconfigure()` with equil=10K USDC/AXUSD, minReserve=1K. Factory V2: `0x138AB9B33741B25bb7BcDa466175c8B2E2b96dc4`, V1: `0x7949bE8B154D7B5ce6E75cBfc646AeF3a25970E2`.
