...
export default function DawesRollPage() {
  ...
  return (
    <>
      <Head>
        <title>Dawes Roll Search | Land Reclamation Workbook</title>
      </Head>

      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white">
          <div className="max-w-4xl mx-auto px-4 py-6">
            <Link href={`/workbook/case/${id}`} className="text-teal-200 hover:text-white text-sm mb-2 inline-block">
              ← Back to Case
            </Link>
            ...
            <p className="text-teal-100 mt-1">Search Five Civilized Tribes enrollment records (1898-1914)</p>
          </div>
        </header>
