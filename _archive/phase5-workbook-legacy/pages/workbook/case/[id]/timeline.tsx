...
export default function TimelinePage() {
  ...
  return (
    <>
      <Head>
        <title>Timeline | Land Reclamation Workbook</title>
      </Head>
      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-amber-600 to-orange-600 text-white">
          <div className="max-w-4xl mx-auto px-4 py-6">
            ...
            <h1 className="text-2xl font-bold">Ownership Timeline</h1>
            <p className="text-amber-100 mt-1">Visual history of land ownership and key events</p>
          </div>
        </header>
