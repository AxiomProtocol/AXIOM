...
export default function DocumentsPage() {
  ...
  return (
    <>
      <Head>
        <title>Saved Documents | Land Reclamation Workbook</title>
      </Head>

      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <div className="max-w-6xl mx-auto px-4 py-6">
            <Link href={`/workbook/case/${caseId}`} className="text-blue-100 hover:text-white text-sm mb-2 inline-block">
              ← Back to Case
            </Link>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <span>📄</span> Saved Documents & Records
            </h1>
            <p className="text-blue-100 mt-1">View all records saved from your searches</p>
          </div>
        </header>
