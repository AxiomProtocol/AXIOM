...
export default function NotesPage() {
  ...
  return (
    <>
      <Head>
        <title>Research Notes | Land Reclamation Workbook</title>
      </Head>

      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-yellow-500 to-amber-500 text-white">
          <div className="max-w-6xl mx-auto px-4 py-6">
            <Link href={`/workbook/case/${caseId}`} className="text-yellow-100 hover:text-white text-sm mb-2 inline-block">
              ← Back to Case
            </Link>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <span>📝</span> Research Notes
            </h1>
            <p className="text-yellow-100 mt-1">Document your findings and research progress</p>
          </div>
        </header>
