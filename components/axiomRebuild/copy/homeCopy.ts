export const homeCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      primaryCta: { label: "See the Infrastructure Roadmap", href: "/infrastructure?section=roadmap" },
      secondaryCta: { label: "Why Logistics Matters", href: "/infrastructure?section=why" }
    },
    {
      id: "platform",
