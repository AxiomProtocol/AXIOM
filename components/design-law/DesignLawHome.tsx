...
const SYSTEM_LAYERS = [
  ...
  },
  {
    ...
    title: 'AXUSD Rail',
    desc: 'The protocol\'s identity-gated stablecoin. Settlement, transactional capital, and PSM-backed mint/redeem. ERC-3643 identity standard required.',
    href: '/axusd-3643',
    status: 'LIVE',
    statusColor: 'text-dl-forest',
  ...
  },
  {
    ...
    title: 'Solvency + Banking',
    desc: 'Institutional solvency console (three-mode, live on-chain), FDIC-insured banking (Increase.com), and institutional-grade disclosure.',
    href: '/solvency',
    status: 'LIVE',
    statusColor: 'text-dl-forest',
    accent: 'border-l-dl-navy',
...
const LIVE_STATUS = [
  ...
  { system: 'Lending Fund (Reg D 506(c))', status: 'CONFIGURED', note: 'Accredited investors. Bridge loan mandate. Formation stage.', href: '/lending-fund' },
  { system: 'Capital Program (SPVs)', status: 'CONFIGURED', note: 'Dual-asset. 35/35/20/10 allocation. Formation stage.', href: '/pilot' },
  { system: 'Wealth Practice Groups', status: 'CONFIGURED', note: '10 hubs seeded. Groups forming across 3 cities.', href: '/wealth-practice' },
