  ...
  if (!isConnected) {
    return (
      <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 text-center">
        ...
        <p className="text-gray-400 text-sm">Connect wallet to view rewards</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-white">Trading Rewards</h3>
          <button
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-white">Limit Orders</h3>
          <button
        ...
        {ordersLoading ? (
          ...
          <div className="text-center py-4">
            <p className="text-gray-400 text-sm">No active limit orders</p>
          </div>
        ) : (
