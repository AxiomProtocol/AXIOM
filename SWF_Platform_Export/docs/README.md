...
│   ├── deployPolygon.js              # Polygon mainnet deployment script
│   ├── deployPolygonUltra.js         # Ultra-optimized mainnet deployment script
│   ├── deployPolygonFast.js          # Fast mainnet deployment script
...
- Polygon mainnet account with MATIC tokens
...
```bash
npx hardhat run scripts/deployPolygonUltra.js --network polygon
```

Monitor deployment status:
```bash
npx hardhat run scripts/checkDeployment.js --network polygon
```
...
The SWF token ecosystem is deployed and accessible at:

- **Production URL**: [https://sovran-wealth-token-pnandnpn.replit.app](https://sovran-wealth-token-pnandnpn.replit.app)

### Available Features at Production URL
...
- Production Delegation Interface
- Mobile-Friendly Dashboard

### Deployment Components

The production deployment includes:
1. SWF API Server - Main dashboard and API endpoints
2. Delegation Redemption Server - Handles token delegation functionality
3. Auto-Deployment System - Manages deployment configuration
