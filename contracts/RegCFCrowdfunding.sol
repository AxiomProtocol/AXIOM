...
contract RegCFCrowdfunding is AccessControl, Pausable, ReentrancyGuard {
    ...
    function createCampaign(
        ...
        newCampaign.landOptionId = landOptionId;
        newCampaign.title = title;
        newCampaign.description = description;
        newCampaign.targetAmount = targetAmount;
        newCampaign.minInvestment = minInvestment;
        newCampaign.maxInvestment = maxInvestment;
        newCampaign.raisedAmount = 0;
        newCampaign.investorCount = 0;
        newCampaign.startDate = 0;
        newCampaign.endDate = 0;
        newCampaign.status = CampaignStatus.Draft;
        newCampaign.issuer = msg.sender;
        newCampaign.offeringDocumentCID = offeringDocumentCID;
        newCampaign.requiresAccreditation = requiresAccreditation;
