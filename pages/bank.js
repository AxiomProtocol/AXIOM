...
const BANKING_PRODUCTS = [
  ...
  { id: 'home-mortgage', name: 'Axiom Home Mortgage', category: 'lending', description: 'Tokenized mortgages for Axiom community properties', apy: '4.5%', fees: '1% origination', features: ['Tokenized title', 'Up to 30 years', 'Low rates', 'On-chain settlement'], icon: '🏠', riskLevel: 'low' },
  ...
  { id: 'mutual-funds', name: 'Axiom Index Funds', category: 'investments', description: 'Low-cost index funds tracking community economy', apy: '8-12%', fees: '0.05% expense ratio', features: ['Diversified', 'Low fees', 'Auto-invest', 'Dividend reinvestment'], icon: '📊', riskLevel: 'medium' },
  ...
  { id: 'real-estate-tokens', name: 'Fractional Real Estate', category: 'tokenized', description: 'Own fractions of Axiom community properties', apy: '6-9% rental yield', minimumBalance: '100 AXM', fees: '2% acquisition', features: ['Fractional ownership', 'Monthly dividends', 'Liquid market', 'Professional management'], icon: '🏘️', riskLevel: 'medium' },
  ...
  { id: 'infrastructure-bonds', name: 'Community Infrastructure Bonds', category: 'tokenized', description: 'Municipal bonds funding Axiom infrastructure projects', apy: '4.5%', minimumBalance: '5,000 AXM', fees: 'No fees', features: ['Tax-free income', 'Government backed', 'Fixed income', 'Transferable'], icon: '🌉', riskLevel: 'low' },
