/**
 * /disclosure/information-security-policy — Canonical Akili Group infosec policy.
 *
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Akili Group, LLC information security policy: governance, access management, infrastructure controls, vendor risk, vulnerability management, incident response."
        />
      </Head>
      <DesignLawLayout>
        <div className="mb-6">
