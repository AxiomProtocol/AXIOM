...
export default function DaoAccountDashboardPage() {
  return (
    <DesignLawLayout>
      <Head>
        <title>DAO Account Dashboard | Axiom Protocol</title>
      </Head>
      <div className="border border-dl-border bg-dl-bg-alt px-8 py-12 text-center max-w-2xl mx-auto mt-12">
        <p className="font-dl-mono text-xs text-dl-gray uppercase tracking-widest mb-4">DAO Treasury Dashboard</p>
