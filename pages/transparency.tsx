...
const CONTRACTS: ContractInfo[] = [
  ...
  { category: 'Core', name: 'AXM Governance Token', address: '0x864F9c6f50dC5Bd244F5002F1B0873Cd80e2539D', network: 'Arbitrum One', verified: true, description: 'ERC20 governance token (AXM). 15B supply. Participation lockup, governance, and protocol fee routing.', status: 'Live' },
  ...
  { category: 'Core', name: 'Participation and Emissions Hub', address: '0x8b99cDeefB3116cA87AF24A9E10D5580dA07B885', network: 'Arbitrum One', verified: true, description: 'Tiered AXM participation lockup with emissions schedule and governance weight allocation.', status: 'Live' },
...
export default function TransparencyPage() {
  ...
  return (
    <DesignLawLayout>
      ...
      {/* ── Phase 3 Oracle and Valuation Readiness ─────────────────────────────── */}
