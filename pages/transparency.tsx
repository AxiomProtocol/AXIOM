...
const CONTRACTS: ContractInfo[] = [
  ...
  { category: 'AXUSD', name: 'AXUSD Unified Stablecoin (ERC-3643)', address: '0x73585df5E62a5E85E6dd6b1df3C08E00eee5b89C', network: 'Arbitrum One', verified: true, description: 'Primary AXUSD stablecoin designed to align with GENIUS Act framework. ERC-3643 (T-REX) with on-chain identity enforcement and 100% reserve backing. 1M AXUSD in circulation.', status: 'Live' },
  { category: 'AXUSD', name: 'GENIUS PSM (Peg Stability Module)', address: '0x5db58d9c21369d1532a48Bdd658E4Fe415404922', network: 'Arbitrum One', verified: true, description: '1:1 USDC/AXUSD swaps for peg stability. 5M debt ceiling. Primary peg anchor for AXUSD.', status: 'Live' },
  ...
  { category: 'Planned', name: 'Lease and Rent Engine', address: '0x00591d360416dE7b016bBedbC6AA1AE798eA873B', network: 'Arbitrum One', verified: true, description: 'KeyGrow rent-to-own payment automation. Deployed and security-audited. Activation planned in a future product phase.', status: 'Configured-Inactive' },
