...
const CONTRACTS: ContractInfo[] = [
  ...
  { category: 'AXUSD', name: 'Legacy GENIUS PSM (Peg Stability Module)', address: '0x5db58d9c21369d1532a48Bdd658E4Fe415404922', network: 'Arbitrum One', verified: true, description: 'Legacy PSM paired with Legacy Primary AXUSD (GENIUS). USDC reserves remain valid for solvency accounting. Superseded by Canonical PSM for new ERC-3643 issuance. No new mint/redeem intended.', status: 'Configured-Inactive' },
