...
const STATE_LAWS: Record<string, {
  ...
  'AL': { name: 'Alabama', intestateRules: 'Spouse gets first $50k + 1/2 if children exist', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate affidavit for estates under $25,000' },
  'AK': { name: 'Alaska', intestateRules: 'Community property state - spouse gets all community property', hasUPHPA: false, affidavitAvailable: true, notesForHeirs: 'Affidavit for real property under $100,000' },
  'AZ': { name: 'Arizona', intestateRules: 'Community property - spouse gets all if only mutual children', hasUPHPA: false, affidavitAvailable: true, notesForHeirs: 'Small estate affidavit for personal property under $75,000' },
  'AR': { name: 'Arkansas', intestateRules: 'Spouse gets 1/3 if children, 1/2 of personalty', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate proceeding for estates under $100,000' },
  'CA': { name: 'California', intestateRules: 'Community property - spouse gets all community, 1/3-1/2 of separate', hasUPHPA: false, affidavitAvailable: true, notesForHeirs: 'Affidavit for real property under $184,500' },
  'CO': { name: 'Colorado', intestateRules: 'Spouse gets first $150k + 1/2 if children', hasUPHPA: false, affidavitAvailable: true, notesForHeirs: 'Small estate affidavit for estates under $70,000' },
  'CT': { name: 'Connecticut', intestateRules: 'Spouse gets first $100k + 1/2 if children', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate settlement for under $40,000' },
  'FL': { name: 'Florida', intestateRules: 'Spouse gets all if only mutual descendants', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Summary administration for estates under $75,000' },
  'GA': { name: 'Georgia', intestateRules: 'Spouse shares equally with children (min 1/3)', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'No administration needed for estates under $10,000' },
  'IL': { name: 'Illinois', intestateRules: 'Spouse gets 1/2 if children, all if no children', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate affidavit for under $100,000' },
  'LA': { name: 'Louisiana', intestateRules: 'Civil law state - usufruct rules apply', hasUPHPA: false, affidavitAvailable: false, notesForHeirs: 'Succession proceeding required - unique civil law system' },
  'MD': { name: 'Maryland', intestateRules: 'Spouse gets 1/2 if minor children, all if no children', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate for under $50,000 or $100,000 if spouse is heir' },
  'MS': { name: 'Mississippi', intestateRules: 'Spouse shares equally with children', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Affidavit of heirship commonly used for land' },
  'NC': { name: 'North Carolina', intestateRules: 'Spouse gets first $60k + 1/2 or first $100k + 1/2 depending on children', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Summary administration for small estates' },
  'OK': { name: 'Oklahoma', intestateRules: 'Spouse gets 1/2 of property acquired during marriage', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Important for Indian allotment lands' },
  'SC': { name: 'South Carolina', intestateRules: 'Spouse gets 1/2 if children, all if no children', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Center for Heirs Property Preservation in Charleston' },
  'TN': { name: 'Tennessee', intestateRules: 'Spouse gets 1/3 or child\'s share, whichever greater', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate affidavit for under $50,000' },
  'TX': { name: 'Texas', intestateRules: 'Community property - spouse keeps 1/2, gets 1/3 of separate', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Affidavit of heirship + 5-year possession common' },
  'VA': { name: 'Virginia', intestateRules: 'Spouse gets all if mutual children only, 1/3 otherwise', hasUPHPA: true, affidavitAvailable: true, notesForHeirs: 'Small estate affidavit for under $50,000' },
};
