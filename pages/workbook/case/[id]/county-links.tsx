...
export default function CountyLinksPage() {
  ...
  return (
    <>
      <Head>
        <title>County Records | Land Reclamation Workbook</title>
      </Head>

      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-rose-600 to-pink-600 text-white">
          <div className="max-w-4xl mx-auto px-4 py-6">
            <Link href={`/workbook/case/${id}`} className="text-rose-200 hover:text-white text-sm mb-2 inline-block">
              ← Back to Case
            </Link>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <span className="text-3xl">🏛️</span>
              County Records & Resources
            </h1>
            <p className="text-rose-200 mt-1">Find local deed, tax, and probate record offices</p>
          </div>
        </header>
