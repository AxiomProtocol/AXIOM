...
export default function StewardRecruitPage() {
  ...
  useEffect(() => {
    track('steward_recruit_page_view', { page: 'steward-recruit' });
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        setSubmitted(true);
        track('steward_interest_submitted', { region: form.region });
      } else {
      ...
      <main style={{ minHeight: '100vh', background: '#FAFBFC' }}>
        <section style={{
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '20px', opacity: 0.9, marginBottom: '16px', maxWidth: '600px', margin: '0 auto 24px' }}>
                ...
                <div style={{
                  ...
                  <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <p style={{ fontSize: '12px', color: '#9CA3AF', textAlign: 'center', margin: 0 }}>
                      ...
                      <Link href="/privacy-policy" style={{ color: web3Theme.colors.primary }}>privacy policy</Link>.
                    </p>
                  </form>
                </div>
              </div>
