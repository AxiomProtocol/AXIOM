    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden flash-mesh-gradient">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 lg:py-32">
          ...
          >
            ...
            >
              ...
              />
              <span className="text-sm text-amber-600 font-medium">Live on Arbitrum One</span>
      ...
      <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            <a 
              href="https://youtu.be/GMGROgDvLUo" 
              target="_blank" 
              rel="noopener noreferrer"
              className="block aspect-video relative group cursor-pointer"
            >
              <img 
                src="https://img.youtube.com/vi/GMGROgDvLUo/maxresdefault.jpg" 
                alt="Discover The Wealth Practice"
                className="w-full h-full object-cover"
                onError={(e) => { e.target.src = 'https://img.youtube.com/vi/GMGROgDvLUo/hqdefault.jpg'; }}
              />
      ...
      <section className="py-20 bg-gray-50 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900">
              <span className="text-amber-600">29 Smart Contracts</span> Deployed & Verified
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">Official AXM Token Contract</h2>
              <p className="text-amber-600">Verified on Arbitrum One | Chain ID: 42161</p>
            </div>
          </div>
          ...
          <div className="flash-token-card rounded-2xl p-6 mb-6">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
              <div className="flex-1 w-full">
                ...
                <code className="text-amber-600 font-mono text-sm md:text-lg break-all block">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors"
                >
                  View Token
                </a>
              </div>
          ...
          <div className="text-center">
            <Link 
              ...
              className="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 transition-colors text-sm"
            >
