          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/insurance-pools" className="text-gray-300 hover:text-white">Insurance</Link>
                <Link href="/treasury-notes" className="text-yellow-400 font-semibold">Treasury</Link>
              </div>
              <WalletButton />
            </div>
          </div>
