        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 max-w-xl mx-auto mt-3">
              Wealth Practice coordinates member-directed savings activity and education. It is not a promise of profit and is not financial advice.
            </p>
            <div className="flex justify-center mt-4">
              ...
              >
                ...
                Graduation Framework (Whitepaper)
              </Link>
            </div>
