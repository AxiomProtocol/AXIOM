        ...
        <div id="token-contract" className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 mb-12 border border-amber-500/30">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-amber-500 rounded-full flex items-center justify-center">
              <img src="/images/axiom-token.png" alt="AXM" className="w-10 h-10 rounded-full" onError={(e) => { e.target.onerror = null; e.target.src = '/images/axiom-token-fallback.svg'; }} />
            </div>
            <div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-white border border-amber-200 rounded-2xl p-8">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0">
              <img src="/images/axiom-token.png" alt="AXM" className="w-8 h-8 rounded-full" onError={(e) => { e.target.onerror = null; e.target.src = '/images/axiom-token-fallback.svg'; }} />
            </div>
            <div>
