...
interface Props { items: Item[]; adapterFilter: string; loadError: string | null }
...
export const getServerSideProps: GetServerSideProps<Props> = async (ctx) => {
  ...
  try {
    ...
    console.error('[operator/webhooks/quarantine] failed to load quarantined events:', msg, err);
    return {
      props: {
        adapterFilter,
        items: [],
        ...
        {loadError && (
          <div className="border border-dl-gold bg-dl-bg-alt p-4 mb-4 font-dl-mono text-xs">
            ...
            <div className="text-dl-ink">
              Quarantine data could not be loaded. Showing empty result. Operations has been notified.
