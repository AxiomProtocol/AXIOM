 ...
 * Euler vault stats endpoint has been removed from Axiom Protocol.
 * This route is permanently decommissioned. Refer to the multi-chain
 * DeFi stack: /api/aave/arbitrum/market, /api/aave/arbitrum/user.
 */
