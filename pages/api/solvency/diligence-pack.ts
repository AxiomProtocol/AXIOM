...
export default async function handler(
  ...
  try {
    ...
    const pack = {
      ...
      knownIssues: [
        { id: 'KI-001', description: 'Deployer EOA holds mint authority on ERC-3643 AXUSD', severity: 'High', mitigation: 'Migration to Governance Safe + PSM addAgent() in progress' },
