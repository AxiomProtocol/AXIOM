...
import { getPruneAlertLogStatus, type PruneAlertLogStatus } from '../../../lib/admin/prune-alert';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    let alertLogStatus: PruneAlertLogStatus | null = null;
    try {
      alertLogStatus = await getPruneAlertLogStatus();
    } catch (err: unknown) {
      console.error('[api/admin/oracle-fallbacks] alert-log status query failed:', err);
    }
