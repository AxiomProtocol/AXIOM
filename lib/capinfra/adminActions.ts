...
export type DualActorActionType =
  ...
  | 'ach.mode.transition'
  | 'ach.emergency_disable.acknowledged'
  // Collateral Risk Policy: guardian disable of an asset's collateral
  // admission. Forces collateral_class → RED. Dual-actor: a distinct
  // second operator must witness the disable (see Collateral Risk Policy §7).
  | 'collateral.guardian_disable';
