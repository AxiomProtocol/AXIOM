export const NAV_ITEMS = [
  ...
  { name: 'Tools', href: '/bank', isDropdown: true },
...
export const ADVANCED_DROPDOWN = [
  ...
  { name: 'Observation Window Rationale', href: '/governance/observation-window' },
  ...
  { name: 'Node Operator Portal', href: '/operator' },
  { name: 'Note Acquisition Pipeline', href: '/notes/pipeline' },
...
export const FOOTER_TOOLS = [
  ...
  { name: 'The Wealth Practice', href: '/wealth-practice' },
  { name: 'Governance', href: '/governance' },
  { name: 'Observation Window', href: '/governance/observation-window' },
  { name: 'Tokenomics', href: '/tokenomics' },
  { name: 'Staking', href: '/staking' },
  { name: 'Launchpad', href: '/launchpad' },
];
