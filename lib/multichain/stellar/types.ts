...
export const ANCHOR_CANDIDATES: AnchorCandidate[] = [
  ...
  {
    anchorId: 'vibrant-stellar',
    anchorName: 'Vibrant (LATAM — ARS)',
    website: 'https://vibrant.app',
    corridors: ['USDC → ARS (Argentine Peso)', 'ARS → USDC'],
    primaryCurrencies: ['USDC', 'ARS'],
    primaryRegions: ['Argentina'],
    sep24Support: true,
    sep31Support: false,
    sep38Support: false,
    partnershipRequired: false,
    evaluationStatus: 'evaluating',
    notes: 'Vibrant is a Stellar-native SEP-24 anchor focused on USDC ↔ ARS. Widely used in Argentina for inflation-hedging. Stellar Community Fund recipient. Complements Anclap — offers a second LATAM ARS corridor for redundancy.',
  },
  {
...
export const STELLAR_ANCHOR_REGISTRY: Record<string, StellarAnchorRegistryEntry> = {
  ...
  vibrant: {
    homeDomain: 'vibrant.app',
    anchorId: 'vibrant-stellar',
    anchorName: 'Vibrant (LATAM — ARS)',
    usdcIssuer: 'GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN',
    network: 'mainnet',
    transferServerSep24: 'https://anchor.vibrant.app/sep24',
    webAuthEndpoint: 'https://anchor.vibrant.app/auth',
  },
  cowrie: {
...
export const STELLAR_PLANNED_CORRIDORS: StellarPaymentCorridor[] = [
  ...
  {
    corridorId: 'axusd-to-usdc-stellar-ars-vibrant',
    label: 'AXUSD (Arbitrum) → USDC (Stellar) → ARS via Vibrant',
    sourceAsset: 'AXUSD',
    sourceNetwork: 'arbitrum',
    destinationCurrency: 'ARS',
    destinationCountry: 'AR',
    ...
    maxAmountUsd: 5000,
    complianceRequired: true,
    blockers: ['Requires Vibrant SEP-24 endpoint verification and activation'],
  },
  {
