...
export const STELLAR_PLANNED_CORRIDORS: StellarPaymentCorridor[] = [
  {
    ...
    label: 'USDC (Stellar) → USD via Axiom Rail RTP',
    sourceAsset: 'USDC',
  ...
  },
  {
    ...
    label: 'USD (RTP) → USDC via Axiom Rail Deposit',
    sourceAsset: 'USD',
  ...
  {
    corridorId: 'axusd-arb-to-usd-axiom-rail-rtp',
    label: 'AXUSD (Arbitrum) → USD via Axiom Rail RTP',
    sourceAsset: 'AXUSD',
  ...
  {
    corridorId: 'axau-arb-to-usd-axiom-rail-rtp',
    label: 'AXAU (Arbitrum) → USD via Axiom Rail RTP',
    sourceAsset: 'AXAU',
    sourceNetwork: 'arbitrum',
    destinationCurrency: 'USD',
    destinationCountry: 'US',
