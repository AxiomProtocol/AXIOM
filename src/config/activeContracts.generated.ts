 ...
 * retained for reference and PSM USDC reserve tracking only.
 *
 * ACTIVE_AXUSD: ERC-3643 Unified AXUSD — canonical production token (0xD6110F59)
 * LEGACY_GENIUS_AXUSD: Legacy Primary AXUSD — deprecated, PSM-paired (0x73585df5)
 * EULER_AXUSD: Original AxiomStable — deprecated, Euler Vault.asset() binding only
 * ACTIVE_PSM: GENIUS PSM — USDC reserves valid; paired with LEGACY_GENIUS_AXUSD, not ERC-3643
 * EULER_PSM: Legacy PSM — paired with EULER_AXUSD (deprecated)
 *
 * NOTE ON PSM: The PSM at ACTIVE_PSM mints LEGACY_GENIUS_AXUSD, not ERC-3643 AXUSD.
 * No ERC-3643 PSM has been deployed. PSM USDC balance (the collateral) is still a
 * real protocol reserve asset and is reported as such in solvency calculations.
 * Direct AXUSD (ERC-3643) issuance is currently admin-controlled via the owner key.
 *
 * Evidence (as of last verification):
