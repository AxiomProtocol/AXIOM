  ...
  try {
    ...
    const result = await db
      ...
      .values({
        ...
        samplingPercentage: String(summaryData.samplingPercentage),
        samplingConfidencePercentage: String(summaryData.samplingConfidencePercentage),
        ...
        estimatedTotalRehabCost: String(summaryData.estimatedTotalRehabCost),
        estimatedAvgCostPerUnit: String(summaryData.estimatedAvgCostPerUnit),
