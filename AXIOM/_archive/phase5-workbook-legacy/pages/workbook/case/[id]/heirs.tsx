...
export default function HeirsCalculatorPage() {
  ...
  return (
    <>
      <Head>
        <title>Heirs Calculator | Land Reclamation Workbook</title>
      </Head>
      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-amber-600 to-orange-600 text-white">
          <div className="max-w-4xl mx-auto px-4 py-6">
            ...
            <h1 className="text-2xl font-bold">Heirs Calculator</h1>
            <p className="text-amber-100 mt-1">Calculate fractional interests for heir property</p>
          </div>
        </header>
