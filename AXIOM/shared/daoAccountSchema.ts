...
export const daoAccountApplications = pgTable('dao_account_applications', {
  ...
  increaseAccountId: varchar('increase_account_id', { length: 200 }),
  increaseAccountNumber: varchar('increase_account_number', { length: 50 }),
  increaseRoutingNumber: varchar('increase_routing_number', { length: 20 }),
