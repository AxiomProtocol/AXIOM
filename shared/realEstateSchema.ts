...
export const reDealMetrics = pgTable("re_deal_metrics", {
  ...
  capRate: decimal("cap_rate", { precision: 6, scale: 4 }),
  cashOnCash: decimal("cash_on_cash", { precision: 6, scale: 4 }),
  dscr: decimal("dscr", { precision: 6, scale: 4 }),
  irr: decimal("irr", { precision: 6, scale: 4 }),
  ...
  rehabRoi: decimal("rehab_roi", { precision: 6, scale: 4 }),
  rentToValue: decimal("rent_to_value", { precision: 6, scale: 4 }),
