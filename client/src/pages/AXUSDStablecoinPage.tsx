...
import { AXUSD_STABLECOIN_CONTRACTS, AXUSD_INTEGRATION_CONTRACTS } from "../../../shared/contracts";

const AXUSD_CONTRACTS = {
  'AXUSD Token': AXUSD_STABLECOIN_CONTRACTS.AXUSD,
  'Vault Engine': AXUSD_STABLECOIN_CONTRACTS.VAULT_ENGINE,
  'PSM': AXUSD_STABLECOIN_CONTRACTS.PSM,
  'Backstop Vault': AXUSD_STABLECOIN_CONTRACTS.BACKSTOP_VAULT,
  'Oracle Adapter': AXUSD_STABLECOIN_CONTRACTS.ORACLE_ADAPTER,
  'Rate Limiter': AXUSD_STABLECOIN_CONTRACTS.RATE_LIMITER,
  'SEED Yield': AXUSD_INTEGRATION_CONTRACTS.SEED_YIELD_DISTRIBUTOR,
  'Revenue Router': AXUSD_INTEGRATION_CONTRACTS.REVENUE_ROUTER,
  'SUSU Adapter': AXUSD_INTEGRATION_CONTRACTS.SUSU_AXUSD_ADAPTER,
  'KeyGrow Payment': AXUSD_INTEGRATION_CONTRACTS.KEYGROW_PAYMENT,
  'Liquidity Bootstrapper': AXUSD_INTEGRATION_CONTRACTS.LIQUIDITY_BOOTSTRAPPER
};
    ...
    <main className="bg-gradient-to-br from-gray-900 via-gray-800 to-black min-h-screen text-white">
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-green-500/30">
                  <CardHeader>
                ...
                <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-blue-500/30">
                  <CardHeader>
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-yellow-500/30">
                <CardHeader>
                  <CardTitle className="text-yellow-400">How AXUSD Works</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-white mb-2">Deposit Collateral</h3>
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-white mb-2">Mint AXUSD</h3>
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-white mb-2">Use Anywhere</h3>
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-white mb-2">Earn Yield</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-green-500/30">
                  <CardHeader>
                    <CardTitle className="text-green-400">Accepted Collateral</CardTitle>
                  </CardHeader>
          ...
          {activeTab === 'mint' && (
            <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-green-500/30 max-w-2xl mx-auto">
              <CardHeader>
                <CardTitle className="text-green-400 text-center">Mint AXUSD</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <Button className="w-full py-4 bg-green-500 hover:bg-green-600 text-black font-bold text-lg rounded-xl">
          ...
          {activeTab === 'psm' && (
            <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-blue-500/30 max-w-2xl mx-auto">
              <CardHeader>
                <CardTitle className="text-blue-400 text-center">Peg Stability Module</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex gap-4">
                  <button
                ...
                <Button className="w-full py-4 bg-blue-500 hover:bg-blue-600 text-black font-bold text-lg rounded-xl">
          ...
          {activeTab === 'vaults' && (
            <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-purple-500/30">
              <CardHeader>
                <CardTitle className="text-purple-400 text-center">My Vaults</CardTitle>
              </CardHeader>
          ...
          {activeTab === 'earn' && (
            <div className="space-y-6">
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-yellow-500/30">
                <CardHeader>
                  <CardTitle className="text-yellow-400">SEED Yield Distribution</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-700/50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-white mb-4">How to Earn</h3>
                    ...
                    <div className="bg-gray-700/50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-white mb-4">Current Epoch</h3>
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-green-500/30">
                <CardHeader>
                  <CardTitle className="text-green-400">AXUSD Use Cases</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-gray-700/50 rounded-xl">
                      ...
                      <h3 className="font-bold text-white mb-2">SUSU Circles</h3>
                    ...
                    <div className="text-center p-6 bg-gray-700/50 rounded-xl">
                      ...
                      <h3 className="font-bold text-white mb-2">KeyGrow Housing</h3>
                    ...
                    <div className="text-center p-6 bg-gray-700/50 rounded-xl">
                      ...
                      <h3 className="font-bold text-white mb-2">DeFi Liquidity</h3>
